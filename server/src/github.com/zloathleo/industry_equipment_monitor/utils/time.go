...
获得指定时间的整秒钟值
*/
func GetTimeIntSec(givenTime time.Time) time.Time {
	return time.Date(givenTime.Year(), givenTime.Month(), givenTime.Day(), givenTime.Hour(), givenTime.Minute(), givenTime.Second(), 0, givenTime.Location())
}
